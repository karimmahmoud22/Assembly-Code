...
SET_DES_SOURCE     PROC
    ...
    SOURCE_HIGHER:CMP  word ptr [SI+1],'H'
    JNE SOURCE_LOWER 
    MOV SRC_FLAG,1
    MOV SRC_SIZE,1
    MOV eBX,OFFSET AX_REG
    ...
    SOURCE_LOWER:CMP  word ptr [SI+1],'L'
    JNE PREREQUIRE 
    MOV SRC_FLAG,1 
    MOV SRC_SIZE,1
    MOV eBX,OFFSET AX_REG
    ...
    SOURCE_HIGHER1:CMP  word ptr [SI+1],'H'
    JNE SOURCE_LOWER1 
    MOV SRC_FLAG,1
    MOV SRC_SIZE,1
    MOV eBX,OFFSET BX_REG
    ...
    SOURCE_LOWER1:CMP  word ptr [SI+1],'L'
    ...
    ;;;;;;;; CHECK BP AFTER B 
    SOURCE_SECOND_HALF:CMP  word ptr [SI+1],'P' 
    JNE PREREQUIRE 
    MOV SRC_FLAG,2 
    MOV SRC_SIZE,2
    ...
    SOURCE_HIGHER2:CMP  word ptr [SI+1],'H'
    JNE SOURCE_LOWER2 
    MOV SRC_FLAG,1
    MOV SRC_SIZE,1
    MOV eBX,OFFSET CX_REG
    ...
    SOURCE_LOWER2:CMP  word ptr [SI+1],'L'
    JNE PREREQUIRE 
    MOV SRC_FLAG,1 
    MOV SRC_SIZE,1
    MOV eBX,OFFSET CX_REG
    ...
    SOURCE_HIGHER3:CMP  word ptr [SI+1],'H'
    JNE SOURCE_LOWER3 
    MOV SRC_FLAG,1
    MOV SRC_SIZE,1
    MOV eBX,OFFSET DX_REG
    ...
    SOURCE_LOWER3:CMP  word ptr [SI+1],'L'
    ...
    ;;;;;;;;;;;;; CHECK DI AFTER D
    SOURCE_SECOND_HALF1:CMP  word ptr [SI+1],'I' 
    JNE PREREQUIRE 
    MOV SRC_FLAG,2 
    MOV SRC_SIZE,2
   ...
   SRC_PRE2: MOV AL,SRC_SIZE
    ...
    MAD_2:
    MOV CH,0                                       
    MOV eSI,OFFSET INSS          ;;;; SET SI TO THE CORRECT DEGIT
    ADD SI,SRC_START
    ADD SI,CX
    DEC SI
...
;#################################### <-( source is 1 byte reg )-> ############################
     ...
     CMP word ptr [DI],15                    ; memory form 0 - F
