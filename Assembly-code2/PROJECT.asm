...
FOBIDHIM DB "SELECT THE FORBIDDEN CHAR FOR HIM : $"
initialax db "AX: $ "
initialbx db "BX: $ "
initialcx db "CX: $ "
initialdx db "DX: $ "
...
CHANCE DB 1    ;WHEN WE CONCATNATE CHECK IT IN THE LOOP WHEN ONE LOSS
CHANCE2 DB 1
...
endp    
 ...
 VAL PROC 
   ...
   SRC_PRE20: MOV AL,SRC_SIZE
    ...
    MAD_20:
    MOV CH,0                                       
    MOV SI,OFFSET INS          ;;;; SET SI TO THE CORRECT DEGIT
    ADD SI,SRC_START
    ADD SI,CX
    DEC SI
