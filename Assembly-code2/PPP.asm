...
PLAY_GAME:
    ...
    CALL FIRST_PAGE_PLAYER_2              ;COMMENT
    
    MOV AH,0                               ;COMMENT AND MOVE TO DOWN
    MOV AL,POINT2
    CMP AL,POINT1
    JB EQUAL_POINT2 
    MOV AL,POINT1
...
;-------> RECIVE SECOND PLAYER RESPONSE FOR GAME

;-------> RECIVE SECONDE PLAYER NAEM2 AND POINT2 


         CALL SECOND_PAGE_PLAYER_2              ;COMMENT
         CMP PAGE_NUMBER_2,2
         JE PLAY_2
         JMP END_PROGRAM
    ...
    MOV DX,OFFSET START                    ;ONLY IF SEND INV ELSE RECIVE THE LEVEL
    MOV AH,9
    INT 21H
    ...
    MOV DX,OFFSET FOBIDONE          ; COMMENT
    MOV AH,9
    INT 21H
